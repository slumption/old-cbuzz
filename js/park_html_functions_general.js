...
function display_ws(google_ws_array) {
    if(google_ws_array.length > 0) {
        ...
        for (var i = 0; i < google_ws_array.length; i++) {
            var ws_title = '<div class="ads_title"><a class="title-add" href="http://' + google_ws_array[i].ws_url + '" target="_blank">' + google_ws_array[i].ws_title + '</a></div>';
            var ws_description = '<div class="ads_desc">' + google_ws_array[i].ws_description + '</div>';
            var ws_link = '<a class="ads_link" href="http://' + google_ws_array[i].ws_url + '" target="_blank">' + google_ws_array[i].ws_url + '</a>';
